...
function renderTaskCard(phase) {
    ...
    taskContainer.innerHTML = `
        <div class="task-card">
            <div class="task-card-header">
                ...
                <a href="${task.docUrl}" class="source-link" target="_blank" rel="noopener">
    ...
    // Wire up source link click tracking
    const sourceLink = taskContainer.querySelector('.source-link');
    if (sourceLink) {
        sourceLink.addEventListener('click', () => {
            trackEvent('source_link_click', 'source-link');
        });
    }
